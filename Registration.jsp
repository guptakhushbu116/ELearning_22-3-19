...
<h1 style="background-color:threedlightshadow;font-size: x-large;font-family:;">REGISTRATION FORM</h1>
  ...
  <input type="checkbox" class="move-left" onclick="myfun()" align="left">Show Password
  <label>
...
<div>
 ...
 <h4 style="color:brown;">By signing up, you agree to our Terms of use and Privacy Policy.</h4>
</form>
